...
public class Cita {
     ...
     * 
     * @param nCodigo, es el codigo de la cita agendada. nCodigo > 0 && nCodigo !=
     *                 null
     * @param nFecha,  es la fecha de la cita agendada. nFecha != "" && nFecha !=
     *                 null
     * @param nTurno,  es el turno de la cita agendada. nTurno > 0 && nTurno != null
     * @param nLugar,  es el lugar de la cita agendada. nLugar != "" && nLugar !=
     *                 null
     */
    ...
    public void verificarInvariante() {
        ...
        assert lugar != "" : "el lugar no puede ser vacio";
    }
}